...
public class UpdateQueryBuilderTest extends BuilderTest {
  ...
  public void generateUpdateDML() {
    ...
    String query = updateQueryBuilder.createUpdateQuery("USERS", "nick_name", "'value2'","ID", "6");
  ...
  public void insertDMLfromEntity() {
    PersonFixtureStep3 afterUpdatedPerson = new PersonFixtureStep3(1L, "value2",21, "sdafij@gmail.com");
    UpdateQueryBuilder updateQueryBuilder = new UpdateQueryBuilder();

    String query = updateQueryBuilder.createUpdateQuery("USERS", "nick_name", "'value2'","ID", "1");

    jdbcTemplate.execute(query);

    List<Object> people = jdbcTemplate.query("SELECT id,nick_name,old,email FROM USERS WHERE id=1;", (rs) ->
