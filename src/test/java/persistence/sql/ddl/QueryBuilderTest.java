...
class QueryBuilderTest {
    ...
    void persion_ddl_create1() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(new H2Dialect(), new SimpleEntityMetaCreator());
        String expectedDDL = "create table person1 (id bigint not null, age integer , name varchar(255) , primary key (id))";

        String actualDDL = queryBuilder.createDdl(Person1.class);
    ...
    void persion_ddl_create2() {
        ...
        String actualDDL = queryBuilder.createDdl(Person2.class);
    ...
    void persion_ddl_create3() {
        ...
        String actualDDL = queryBuilder.createDdl(Person3.class);
    ...
    void persion_ddl_drop() {
        final DdlDropQueryBuilder queryBuilder = new DdlDropQueryBuilder(new SimpleEntityMetaCreator());
        String expectedDDL = "drop table if exists users CASCADE";

        String actualDDL = queryBuilder.dropDdl(Person3.class);
