...
class QueryBuilderTest {
    ...
    void persion_ddl_create1() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(SimpleEntityMetaCreator.of(Person1.class), new H2Dialect());
    ...
    void persion_ddl_create2() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(SimpleEntityMetaCreator.of(Person2.class), new H2Dialect());
    ...
    void persion_ddl_create3() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(SimpleEntityMetaCreator.of(Person3.class), new H2Dialect());
