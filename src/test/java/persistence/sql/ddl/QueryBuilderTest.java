...
class QueryBuilderTest {
    ...
    void persion_ddl_create1() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(Person1.class, new H2Dialect());
    ...
    void persion_ddl_create2() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(Person2.class, new H2Dialect());
    ...
    void persion_ddl_create3() {
        final DdlCreateQueryBuilder queryBuilder = new DdlCreateQueryBuilder(Person3.class, new H2Dialect());
    ...
    void persion_ddl_drop() {
        final DdlDropQueryBuilder queryBuilder = new DdlDropQueryBuilder(Person3.class, new H2Dialect());
