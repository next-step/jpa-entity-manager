...
public class MetaDataColumnTest {
  ...
  public void createWithIdAnnotation() throws NoSuchFieldException {
    ...
    assertAll(
            () -> assertThat(column.getDBColumnsClause()).isEqualTo("id BIGINT generated by default as identity PRIMARY KEY")
    );
  }
  ...
  public void createWithoutColumnAnnotation() throws NoSuchFieldException {
    ...
    assertAll(
            () -> assertThat(emailColumn.getDBColumnsClause()).isEqualTo("email CHARACTER VARYING NOT NULL")
    );
  }
  ...
  public void createWithNameValueinColumnAnnotation() throws NoSuchFieldException {
    ...
    assertAll(
            () -> assertThat(nameColumn.getDBColumnsClause()).isEqualTo("nick_name CHARACTER VARYING "),
            () -> assertThat(ageColumn.getDBColumnsClause()).isEqualTo("old INTEGER ")
    );
  }
